...
data <- read.table("C:/Users/luisc/Desktop/Cosas/Universidad/3º Tercero/Segundo Cuatrismestre/Bioinformática/Expander/RNA-Seq/GSE100797_ProcessedData.txt", header = TRUE, row.names=1)
